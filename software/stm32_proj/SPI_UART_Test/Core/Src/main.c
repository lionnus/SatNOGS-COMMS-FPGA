...
{
  /* USER CODE BEGIN 1 */
	// Disable internal buffering for input stream of scanf()
  ...
  while (1)
  {
	  char inputBuffer[MAX_SPI_BUFFER_SIZE] = "";
	  		uint8_t spiDataTx[MAX_SPI_BUFFER_SIZE]={0};
	  		...
	  		size_t inputLen = 0;
	  	  	for (; inputBuffer[inputLen]!='\0'; inputLen++)
	  	  	{
